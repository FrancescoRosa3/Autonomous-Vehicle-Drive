...
class ObstaclesManager:
            ...
            for agent in self.measurement_data.non_player_agents:
                if agent.HasField('vehicle'):
                    ...
                    if dist < DISTANCE_VEHICLE - CAR_LONG_SIDE * 2:
                        ...
                        box_pts = _obstacle_to_world(location,  dimension, rotation)
    ...
    def __obstacle_to_world(self, location, dimensions, orientation):
        box_pts = []
