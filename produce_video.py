...
def produce_video():
    ...
    for ep_dir in os.listdir(video_directory):
        ...
        if not skip_folder:
            ...
            os.system("echo y | ffmpeg -r 15 -pattern_type sequence -i " + in_path + "\camera_%d" + parameters_string + ".jpeg -c:v libx264 -pix_fmt yuv420p -r 15 " + camera_out_path)
            os.system("echo y | ffmpeg -r 15 -pattern_type sequence -i " + in_path + "\\trajectory_%d" + parameters_string + ".png -c:v libx264 -pix_fmt yuv420p -r 15 " + trajectory_out_path)
            os.system("echo y | ffmpeg -r 15 -pattern_type sequence -i " + in_path + "\\tl_camera_%d" + parameters_string + ".jpeg -c:v libx264 -pix_fmt yuv420p -r 15 " + tl_out_path)
            os.system("echo y | ffmpeg -r 15 -pattern_type sequence -i " + in_path + "\\fsm_%d" + parameters_string + ".png -c:v libx264 -pix_fmt yuv420p -r 15 " + fsm_out_path)
